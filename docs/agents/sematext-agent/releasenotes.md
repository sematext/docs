...
- Added CentOS and RHEL support to ATA-CLI tool.

### Improvements

- Unified container.name format in Kubernetes environment.
- Added custom-namespace support for Kubernetes. Now you can use any namespace value that you want by using the `STA_NAMESPACE` environment variable.

### Bug Fixes

- Fixed broken system-generators usage for Ubuntu-2404 and Fedora-40.
