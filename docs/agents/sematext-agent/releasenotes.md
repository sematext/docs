...
- Added `/etc/machine-id` as new option to obtain system UUID.
- Addressed MySQL version recognition issue by adding `mariadbd` signature to the MySQL integration.
