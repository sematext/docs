...
To run Logagent you will need a Logs App Token (aka LOGS_TOKEN).  If you don't have Logs Apps yet, you can [create Apps now](https://apps.sematext.com/ui/integrations)
...
-e LOGS_TOKEN=”REPLACE THIS WITH YOUR LOGSENE TOKEN” \
sematext/logagent
```
