...
As soon as an [App](./app-guide) is created, either for [Logs](https://sematext.com/docs/logs/) or [Monitoring](https://sematext.com/docs/monitoring/), you will see several app-specific Alerts Rules created for you by default. 
