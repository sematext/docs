...
| -v /patterns.yml:/etc/logagent/patterns.yml              | Provide custom patterns for log parsing, see logagent-js                                                                                                                                                                                                                                                                                                          |
...
| REMOVE_FIELDS                                            | Removes fields from parsed/enriched logs. E.g. REMOVE_FIELDS=logSource,container_host_name,swarm_node,password,creditCardNo  |
