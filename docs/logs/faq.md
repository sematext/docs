...
your API calls using `apiKey`. You can read more about this [here](/docs/logs/search-through-the-opensearch-api) and [here](/docs/api).
...
If you send your logs via the [Elasticsearch API](/docs/logs/index-events-via-opensearch-api), you can use:
