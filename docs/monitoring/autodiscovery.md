...
[supported integrations](/docs/monitoring/autodiscovery/#which-integrations-allow-autodiscovery). It also [discovers logs](/docs/logs/discovery/intro/) you can ship to Sematext and monitor. To visualize discovered services and their connections, see [Network Map](/docs/network-map/services-view/). To see application-level service dependencies from distributed traces, see [Service Map](/docs/service-map/).
