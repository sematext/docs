...
Once you send custom metrics to any of your Monitoring Apps, you can navigate to the App and create a [Custom Report](https://sematext.com/docs/dashboards/reports-guide/#why-create-custom-reports) where you can visualize the data based on your needs.
