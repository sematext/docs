...
Sematext **Application** and [**Infrastructure Monitoring**](../monitoring/infrastructure), with over [100 integrations](https://sematext.com/integrations/), allows you to collect an extensive set of **events** and over **3700 metrics** across your entire stack.
