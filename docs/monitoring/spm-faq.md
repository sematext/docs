...
If you are running Embedded agents, restart your application/java process.
...
[Standalone](../agents/spm-monitor-standalone) monitor. The
...
2.  In step 2, if you are given a choice between
    [Embedded](../agents/spm-monitor-javaagent/) and
    [Standalone](../agents/spm-monitor-standalone) monitor,
...
After that is done, also do:
  ...
  - if you are using SPM monitor in Embedded mode - restart
...
### I don't see any of my metrics / I am getting errors when starting SPM monitor or when starting my service which uses Embedded version of SPM monitor. What should I check?
...
7.  If you are starting your Jetty (or some other server) with command
    like `java ... -jar start.jar ...` and using the Embedded version of SPM Monitor
