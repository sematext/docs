...
For sematext-agent-java, you can find the properties files for your Monitoring Apps files with:
...
frequency to 30 seconds, for sematext-agent-java simply add the following line to
...
Yes. For sematext-agent-java, simply add or edit the `SPM_MONITOR_LOGGING_LEVEL` property in
