...
## Please refer to [Container Monitoring](/monitoring/containers.md) to set up Sematext Agent for Metrics and [Container Logs](ADD LINK HERE) to set up Logagent
