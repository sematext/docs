...
[Group monitors](http://sematext.com/docs/synthetics/ci-cd/overview/#cicd-groups) run in parallel, so isolate test data and avoid conflicts. This prevents one test from affecting another.
